...
(if (not (executable-find ipython-command))
    ...
    (message "defining ipython-shell-hook")
    (defun ipython-shell-hook ()
      (message "ipython-shell-hook was called")
    ...
    (unless (member "-colors" py-python-command-args)
      (setq py-python-command-args
            ;; RH: py-python-command-args is just a string, not a list...
            (nconc (list py-python-command-args )
                   (list "-colors"
                         (cond

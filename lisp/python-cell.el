...
(defcustom python-cell-highlight-cell nil
...
(defcustom python-cell-highlight-face 'default
...
(defun python-shell-send-cell-and-forward ()
  "Send the cell the cursor is in to python process and move point to next cell"
  (interactive)
